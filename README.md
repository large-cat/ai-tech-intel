...
**人类可翻阅的概念图谱版** → 👉 [https://large-cat.github.io/ai-tech-intel/](https://large-cat.github.io/ai-tech-intel/)

> 左侧有目录导航，可按层级（前置知识→根概念→子概念→实践案例→工具协议）逐层学习。支持全文搜索和章节锚点引用。

**与GitHub仓库的关系**：
- **在线书（mdBook）**：按概念层级组织，人类易读
- **GitHub仓库**：结构化索引 + 机器可读，AI可直接查阅
...
| **看今日摘要** — 当天重点 | 👉 [weekly-digest/2026-05-09.md](weekly-digest/2026-05-09.md) |
...
| 日期 | 一句话总结 |
|------|-----------|
| [2026-05-09](weekly-digest/2026-05-09.md) | Harness工程化成为核心范式、NVIDIA GTC 2026双架构发布、存算一体走向产品前夜 |

> 每天早上 09:30（北京时间）微信推送当日简报。完整版在 `weekly-digest/` 目录。
